...
# TODO - add logging
# TODO - add Routes API calls

class Client:
    """
    This class is designed to create a client for interacting with an ECP MADES SOAP web service.
    ...
    def __init__(self, server, username=None, password=None, debug=False, verify=False, auth=None, wsse=None):
        ...
        wsdl = f'{server}/ECP_MODULE/services/ECPEndpointService.wsdl'
        ...
        self.service = client.create_service(
            binding_name='{http://ecp.entso-e.eu/}ECPEndpointSOAP12',
            address=f'{server}/ECP_MODULE/services/ECPEndpointService')
